...
(function() {
    ...
    function googleplay() {
        var song = $("#currently-playing-title").text() + " - " + $("#currently-playing-title").next().text().split("-")[0],
    ...
    function deezer() {
        ...
        var artist = $('span.player-track-link:nth-child(4)').text();
